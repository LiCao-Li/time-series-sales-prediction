...
setwd("./Desktop/TS/Group Project")
...
write.csv(as.data.frame(template),"./Desktop/TS/Group Project/data.csv")
hts_matrix = read.csv("data.csv",header = TRUE)
dim(hts_matrix)
...
write.csv(as.data.frame(fcst_tdfp_arima[1]),"./Desktop/TS/Group Project/HTS results/hts_tdfp_arima.csv")
write.csv(as.data.frame(fcst_mo_arima_2[1]),"./Desktop/TS/Group Project/HTS results/hts_mo_arima.csv")
write.csv(as.data.frame(fcst_bu_arima[1]),"./Desktop/TS/Group Project/HTS results/hts_bu_arima.csv")
write.csv(as.data.frame(fcst_comb_arima[1]),"./Desktop/TS/Group Project/HTS results/hts_comb_arima.csv")
write.csv(as.data.frame(HTS_order),"./Desktop/TS/Group Project/HTS results/hts_store_order.csv")
write.csv(as.data.frame(hts_matrix_test),"./Desktop/TS/Group Project/hts_test.csv")
...
final_result_tdfp_fit_train = read.csv("./Desktop/TS/Group Project/HTS results/train_SMAPE.csv", head = FALSE)
